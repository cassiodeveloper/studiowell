...
(function ($) {
  ...
  $('.vs-carousel').each(function () {
    ...
    vsSlide.slick({
      ...
      prevArrow: (d('prev-arrow') ? prevButton : '<button type="button" class="slick-prev"><i class="long-arrow"></i></button>'),
      nextArrow: (d('next-arrow') ? nextButton : '<button type="button" class="slick-next"><i class="long-arrow"></i></button>'),
